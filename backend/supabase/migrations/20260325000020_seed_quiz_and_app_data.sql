...
values
  (1, 'I enjoy testing new ideas, even when they seem risky.', 'Openness', 'OpennessToIdeas', 'Your Personality', 1, 'Likert', false, 1.0, 'Free'),
  (2, 'I stick with familiar methods instead of trying new ones.', 'Openness', 'OpennessToIdeas', 'Your Personality', 2, 'Likert', true, 1.0, 'Free'),
  (3, 'I am drawn to art, music, or creative work.', 'Openness', 'Aesthetics', 'Your Personality', 3, 'Likert', false, 1.0, 'Premium'),
  (4, 'I often imagine better ways to do things.', 'Openness', 'Imagination', 'Your Personality', 4, 'Likert', false, 1.0, 'Premium'),
  (5, 'I set high goals and work hard to reach them.', 'Conscientiousness', 'AchievementStriving', 'Your Personality', 5, 'Likert', false, 1.0, 'Free'),
  (6, 'I leave tasks unfinished when something else grabs my attention.', 'Conscientiousness', 'SelfDiscipline', 'Your Personality', 6, 'Likert', true, 1.0, 'Free'),
  (7, 'I like to plan my work before I begin.', 'Conscientiousness', 'Orderliness', 'Your Personality', 7, 'Likert', false, 1.0, 'Premium'),
  (8, 'I follow through on commitments, even when it is hard.', 'Conscientiousness', 'Dutifulness', 'Your Personality', 8, 'Likert', false, 1.0, 'Premium'),
  (9, 'I feel energized after spending time with people.', 'Extraversion', 'Warmth', 'Your Personality', 9, 'Likert', false, 1.0, 'Free'),
  (10, 'I am comfortable taking the lead in a group.', 'Extraversion', 'Assertiveness', 'Your Personality', 10, 'Likert', false, 1.0, 'Free'),
  (11, 'I prefer quiet time alone over busy social settings.', 'Extraversion', 'Gregariousness', 'Your Personality', 11, 'Likert', true, 1.0, 'Premium'),
  (12, 'I enjoy excitement and a fast pace.', 'Extraversion', 'ExcitementSeeking', 'Your Personality', 12, 'Likert', false, 1.0, 'Premium'),
  (13, 'I trust people until they give me a reason not to.', 'Agreeableness', 'Trust', 'Your Personality', 13, 'Likert', false, 1.0, 'Free'),
  (14, 'I keep the peace, even when I disagree.', 'Agreeableness', 'Compliance', 'Your Personality', 14, 'Likert', false, 1.0, 'Free'),
  (15, 'I try to see situations from other people''s point of view.', 'Agreeableness', 'Tendermindedness', 'Your Personality', 15, 'Likert', false, 1.0, 'Premium'),
  (16, 'I would rather win than share credit with others.', 'Agreeableness', 'Modesty', 'Your Personality', 16, 'Likert', true, 1.0, 'Premium'),
  (17, 'I stay calm when things go wrong.', 'EmotionalStability', 'Anxiety', 'Your Personality', 17, 'Likert', false, 1.0, 'Free'),
  (18, 'I worry about what might go wrong.', 'EmotionalStability', 'Anxiety', 'Your Personality', 18, 'Likert', true, 1.0, 'Free'),
  (19, 'I recover quickly after setbacks.', 'EmotionalStability', 'Vulnerability', 'Your Personality', 19, 'Likert', false, 1.0, 'Premium'),
  (20, 'Small frustrations ruin my mood for the day.', 'EmotionalStability', 'AngryHostility', 'Your Personality', 20, 'Likert', true, 1.0, 'Premium'),
  (21, 'I enjoy building or fixing things with my hands.', 'Realistic', '', 'Your Interests', 1, 'Interest', false, 1.0, 'Free'),
  (22, 'I like using tools, machines, or equipment.', 'Realistic', '', 'Your Interests', 2, 'Interest', false, 1.0, 'Free'),
  (23, 'I enjoy hands-on work outdoors.', 'Realistic', '', 'Your Interests', 3, 'Interest', false, 1.0, 'Premium'),
  (24, 'I like digging into complex problems to understand them.', 'Investigative', '', 'Your Interests', 4, 'Interest', false, 1.0, 'Free'),
  (25, 'I enjoy analyzing data to find patterns.', 'Investigative', '', 'Your Interests', 5, 'Interest', false, 1.0, 'Free'),
  (26, 'I like reading in-depth material to learn new ideas.', 'Investigative', '', 'Your Interests', 6, 'Interest', false, 1.0, 'Premium'),
  (27, 'I enjoy creating things that look visually appealing.', 'Artistic', '', 'Your Interests', 7, 'Interest', false, 1.0, 'Free'),
  (28, 'I like writing or creating original content.', 'Artistic', '', 'Your Interests', 8, 'Interest', false, 1.0, 'Free'),
  (29, 'I enjoy expressing ideas in front of other people.', 'Artistic', '', 'Your Interests', 9, 'Interest', false, 1.0, 'Premium'),
  (30, 'I enjoy helping people through personal challenges.', 'Social', '', 'Your Interests', 10, 'Interest', false, 1.0, 'Free'),
  (31, 'I like teaching or mentoring others.', 'Social', '', 'Your Interests', 11, 'Interest', false, 1.0, 'Free'),
  (32, 'I enjoy volunteering for causes that help people.', 'Social', '', 'Your Interests', 12, 'Interest', false, 1.0, 'Premium'),
  (33, 'I enjoy persuading people to support an idea.', 'Enterprising', '', 'Your Interests', 13, 'Interest', false, 1.0, 'Free'),
  (34, 'I like leading teams toward ambitious goals.', 'Enterprising', '', 'Your Interests', 14, 'Interest', false, 1.0, 'Free'),
  (35, 'I am excited by starting projects from scratch.', 'Enterprising', '', 'Your Interests', 15, 'Interest', false, 1.0, 'Premium'),
  (36, 'I enjoy organizing information so things run smoothly.', 'Conventional', '', 'Your Interests', 16, 'Interest', false, 1.0, 'Free'),
  (37, 'I like following clear procedures to get accurate results.', 'Conventional', '', 'Your Interests', 17, 'Interest', false, 1.0, 'Free'),
  (38, 'I enjoy working with budgets, numbers, or records.', 'Conventional', '', 'Your Interests', 18, 'Interest', false, 1.0, 'Premium'),
  (39, 'Having freedom in how I work matters a lot to me.', 'Autonomy', '', 'What Drives You', 1, 'Likert', false, 1.0, 'Free'),
  (40, 'I value job stability over risky opportunities.', 'Security', '', 'What Drives You', 2, 'Likert', false, 1.0, 'Free'),
  (41, 'I do my best work when I am challenged.', 'Challenge', '', 'What Drives You', 3, 'Likert', false, 1.0, 'Free'),
  (42, 'Making a positive impact is important to me.', 'Service', '', 'What Drives You', 4, 'Likert', false, 1.0, 'Free'),
  (43, 'Keeping balance between work and personal life is essential to me.', 'WorkLifeBalance', '', 'What Drives You', 5, 'Likert', false, 1.0, 'Free'),
  (44, 'I want to become an expert in my field.', 'Challenge', 'TechnicalCompetence', 'What Drives You', 6, 'Likert', false, 1.0, 'Premium'),
  (45, 'I want responsibility for leading people and results.', 'Enterprising', 'Management', 'What Drives You', 7, 'Likert', false, 1.0, 'Premium'),
  (46, 'I want to build something of my own.', 'Autonomy', 'Entrepreneurship', 'What Drives You', 8, 'Likert', false, 1.0, 'Premium'),
  (47, 'I would trade pay for work that helps others.', 'Service', 'Dedication', 'What Drives You', 9, 'Likert', false, 1.0, 'Premium'),
  (48, 'I feel restless when my work is not challenging.', 'Challenge', 'PureChallenge', 'What Drives You', 10, 'Likert', false, 1.0, 'Premium'),
  (49, 'I need job security to do my best work.', 'Security', 'Stability', 'What Drives You', 11, 'Likert', false, 1.0, 'Premium'),
  (50, 'I prefer working independently, even with less support.', 'Autonomy', 'Independence', 'What Drives You', 12, 'Likert', false, 1.0, 'Premium'),
  (51, 'I thrive in fast-changing work environments.', 'Pace', '', 'Your Ideal Workplace', 1, 'Likert', false, 1.0, 'Free'),
  (52, 'I do my best work with close team collaboration.', 'Collaboration', '', 'Your Ideal Workplace', 2, 'Likert', false, 1.0, 'Free'),
  (53, 'I prefer clear structure over ambiguity.', 'Structure', '', 'Your Ideal Workplace', 3, 'Likert', false, 1.0, 'Free'),
  (54, 'I prefer working remotely over working in an office.', 'Collaboration', 'Remote', 'Your Ideal Workplace', 4, 'Likert', false, 0.8, 'Premium'),
  (55, 'I prefer small teams over large organizations.', 'Collaboration', 'TeamSize', 'Your Ideal Workplace', 5, 'Likert', false, 0.8, 'Premium'),
  (56, 'I want regular feedback, not just annual reviews.', 'Structure', 'Feedback', 'Your Ideal Workplace', 6, 'Likert', false, 0.8, 'Premium'),
  (57, 'I prefer high-growth environments over stable ones.', 'Pace', 'Growth', 'Your Ideal Workplace', 7, 'Likert', false, 0.8, 'Premium'),
  (58, 'I prefer informal culture over formal culture.', 'Structure', 'Culture', 'Your Ideal Workplace', 8, 'Likert', false, 0.8, 'Premium'),
  (59, 'Under stress, I pull away from people.', 'EmotionalStability', 'StressWithdrawal', 'Under Pressure', 1, 'Likert', true, 0.9, 'Premium'),
  (60, 'Under pressure, I become overly cautious.', 'EmotionalStability', 'StressCaution', 'Under Pressure', 2, 'Likert', true, 0.9, 'Premium'),
  (61, 'Under pressure, I become controlling with others.', 'Agreeableness', 'StressControl', 'Under Pressure', 3, 'Likert', true, 0.9, 'Premium'),
  (62, 'When stressed, I get perfectionistic and struggle to let go.', 'Conscientiousness', 'StressPerfectionism', 'Under Pressure', 4, 'Likert', false, 0.9, 'Premium'),
  (63, 'I stay focused and productive during high-pressure periods.', 'EmotionalStability', 'StressResilience', 'Under Pressure', 5, 'Likert', false, 0.9, 'Premium'),
  (64, 'When work goes wrong, I blame others first.', 'Agreeableness', 'StressBlame', 'Under Pressure', 6, 'Likert', true, 0.9, 'Premium'),
  (65, 'I feel most motivated when I control my tasks and schedule.', 'Autonomy', 'SDTAutonomy', 'Your Needs', 1, 'Likert', false, 1.0, 'Premium'),
  (66, 'I feel stifled when I am micromanaged.', 'Autonomy', 'SDTAutonomy', 'Your Needs', 2, 'Likert', false, 1.0, 'Premium'),
  (67, 'I need to feel competent to stay motivated.', 'Challenge', 'SDTCompetence', 'Your Needs', 3, 'Likert', false, 1.0, 'Premium'),
  (68, 'Learning new skills keeps me engaged.', 'Challenge', 'SDTCompetence', 'Your Needs', 4, 'Likert', false, 1.0, 'Premium'),
  (69, 'Feeling connected to coworkers matters to me.', 'Collaboration', 'SDTRelatedness', 'Your Needs', 5, 'Likert', false, 1.0, 'Premium'),
  (70, 'I feel unfulfilled without meaningful work relationships.', 'Collaboration', 'SDTRelatedness', 'Your Needs', 6, 'Likert', false, 1.0, 'Premium'),
  (71, 'I feel satisfied with my current career direction.', 'EmotionalStability', 'CareerSatisfaction', 'Your Career Journey', 1, 'Likert', false, 0.7, 'Premium'),
  (72, 'I feel ready to decide my next career move.', 'Conscientiousness', 'DecisionReadiness', 'Your Career Journey', 2, 'Likert', false, 0.7, 'Premium'),
  (73, 'I stay focused on long-term career goals.', 'Conscientiousness', 'PassionConsistency', 'Your Career Journey', 3, 'Likert', false, 0.7, 'Premium'),
  (74, 'Setbacks do not stop me from moving toward my goals.', 'EmotionalStability', 'Perseverance', 'Your Career Journey', 4, 'Likert', false, 0.7, 'Premium'),
  (75, 'I often think about changing my career path.', 'Openness', 'CareerExploration', 'Your Career Journey', 5, 'Likert', false, 0.7, 'Premium')
